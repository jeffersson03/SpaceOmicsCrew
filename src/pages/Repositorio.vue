<template>
    <section class="container">
        <h1
            ...
            Repositorio de especie
        </h1>
        <div class="grid" style="grid-template-columns: 320px 1fr; align-items:start;">
            <div class="card">
                <h3 style="margin-top:0;color:var(--accent1)">Filtros</h3>
                <div class="muted">Sistema de cultivo</div>
                ...
                <div class="grid" style="grid-template-columns:1fr 1fr;gap:.6rem;margin-top:.8rem;">
                    <div>
                        <div class="muted">Año desde</div><input type="number" v-model.number="filtros.anio_desde"
                            class="input">
                    </div>
                    <div>
                        <div class="muted">Año hasta</div><input type="number" v-model.number="filtros.anio_hasta"
                            class="input">
                    </div>
                </div>
                <div class="grid" style="grid-template-columns:1fr 1fr;gap:.6rem;margin-top:.8rem;">
                ...
                <button class="btn btn-primary" style="margin-top:.8rem" @click="buscar">Aplicar filtros</button>
            </div>
            <div>
