<template>
  <section class="container" v-if="data">
    ...
    <div class="grid" style="grid-template-columns: 1fr 1fr;">
      <div class="card">
        <h3 style="color:var(--accent1);margin:0 0 .75rem;">Metadatos del Estudio</h3>
        <div class="grid" style="grid-template-columns: 1fr 1fr;">
          <div>
    ...
    <div class="grid" style="grid-template-columns: 1fr 1fr; margin-top:1rem;">
      ...
      <div class="card">
        <h3 style="color:var(--accent1);margin:0 0 .75rem;">Ómicas</h3>
        <table>
          <thead>
            <tr>
              <th>Acceso</th>
  ...
  <section class="container" v-else>
    <p>No se encontró el experimento.</p>
  </section>
</template>
<script setup>
